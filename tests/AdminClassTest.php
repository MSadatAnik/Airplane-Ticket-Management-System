<?php
    ...
    class AdminClassTest extends TestCase {
        ...
        public function testAdminLoginSuccess() {
            ...
            // Prepare the database with a valid admin record
            mysqli_query($con, "INSERT INTO passenger (name, email, passportNo, mobileNo, gender, age, nationality,address, password) VALUES ('Admin Name','admin@example.com',1986,1,'m',1,'b',1, 'password')");
            ...
            mysqli_query($con, "DELETE FROM passenger WHERE email='admin@example.com'");
        }
